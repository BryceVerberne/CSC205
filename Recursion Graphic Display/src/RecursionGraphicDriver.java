...
public class RecursionGraphicDriver extends JFrame //implements ActionListener
{
    public RecursionGraphicDriver()
    {
        setTitle("CSC205AB Recursion Display");
        setSize(430, 400);
        setLocation(50,50);
        ...
        jbtGraph.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent event)
            {
                ...
                formulaResultLabel.setText("" + Recursion.puzzleFormula(n));
                loopResultLabel.setText("" + Recursion.puzzleLoop(n));
                recursionResultLabel.setText("" + Recursion.puzzleRecurse(n));
            }
        }
        );
    }
    ...
    public static void main(String[] args)
    {
        ...
        RecursionGraphicDriver myDriver = new RecursionGraphicDriver();
